...
def test_scanner_lite_snapshot_and_delta_remain_bounded_and_remove_missing_rows(tmp_path):
    ...
    assert ws_mgr.get_current_opportunities_lite_summary()["total"] == 400
